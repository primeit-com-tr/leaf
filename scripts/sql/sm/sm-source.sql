...
GRANT CONNECT, RESOURCE, CREATE SEQUENCE, CREATE PROCEDURE, CREATE TRIGGER TO schema3;

CREATE USER schema4 IDENTIFIED BY schema2_password;
GRANT CONNECT, RESOURCE, CREATE SEQUENCE, CREATE PROCEDURE, CREATE TRIGGER TO schema4;
